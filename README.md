...
Supporter data and branding assets for the [Godimas101 Patreon](https://www.patreon.com/Godimas101).

- **[patreon/](patreon/)** — `supporters.json` (updated daily via n8n) + button images
...
### 🍳 Kitchen
- **[kitchen-inventory/](kitchen-inventory/)** — Ingredients, tools, and appliances. Feed to an LLM for meal planning.
- **[favorite-recipes/](favorite-recipes/)** — Recipes we've tried and liked.
